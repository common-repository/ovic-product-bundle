    ...
    class Ovic_Bundle_Dashboard
    {
        ...
        function remove_bundle_product()
        {
            if ( !current_user_can('manage_options') ) {
                wp_die (esc_html__("You don't have permission to access this page.", 'ovic-bundle') );
            }
        ...
        {
            $value = isset($field['default']) ? get_option(sanitize_text_field($field['id']), $field['default']) : '';
            ?>
            <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="_ovic_search_limit" type="number" min="1"
                                                       max="500"
                                                       value="<?php echo esc_attr(get_option('_ovic_search_limit', '10')); ?>"/>
                                            </td>
                                        </tr>
                                        <tr class="submit">
                                            <th colspan="2">
